...
/**
 * 用于RecyclerView的适配器，支持多选
 */
public abstract class BaseAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<BaseAdapter.SelectionViewHolder<VH>> {
     ...
     */
    public BaseAdapter(Context context, Mode mode, int maxSelectionCount) {

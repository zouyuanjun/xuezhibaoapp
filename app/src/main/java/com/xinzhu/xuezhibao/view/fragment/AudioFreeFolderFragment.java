 ...
 * 音频文件夹分类
 */
public class AudioFreeFolderFragment extends LazyLoadFragment implements VideoFolderInterface {
    ...
    private void loaddata() {
        videoVoiceListPresenter.getVideoFolder(paypage, 2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        payadapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                intent.putExtra(Constants.INTENT_ID3, 3);//标记这是音频课程

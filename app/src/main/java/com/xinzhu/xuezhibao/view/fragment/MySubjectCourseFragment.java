...
public class MySubjectCourseFragment extends LazyLoadFragment implements MyCourseInterface {
    ...
    public static MySubjectCourseFragment newInstance(int type) {
        MySubjectCourseFragment tabFragment = new MySubjectCourseFragment();
    ...
    protected void lazyLoad() {
        Log.d("MySubjectCourseFragment到这里来了");

...
public class PotionsGoodsAdapter extends RecyclerView.Adapter {
    ...
    public PotionsGoodsAdapter(Context mContext, List<GoodsBean> mDatas) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_shoping, parent, false);

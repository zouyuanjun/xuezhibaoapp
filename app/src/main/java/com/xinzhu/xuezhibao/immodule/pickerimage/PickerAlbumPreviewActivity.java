package com.xinzhu.xuezhibao.immodule.pickerimage;
...
import com.xinzhu.xuezhibao.imagepicker.view.ViewPagerFixed;
import com.xinzhu.xuezhibao.immodule.pickerimage.adapter.PickerPreviewPagerAdapter;
import com.xinzhu.xuezhibao.immodule.pickerimage.model.PhotoInfo;
import com.xinzhu.xuezhibao.immodule.pickerimage.model.PickerContract;
import com.xinzhu.xuezhibao.immodule.pickerimage.utils.BitmapDecoder;
import com.xinzhu.xuezhibao.immodule.pickerimage.utils.Extras;
import com.xinzhu.xuezhibao.immodule.pickerimage.utils.ImageUtil;
import com.xinzhu.xuezhibao.immodule.pickerimage.utils.PickerUtil;
import com.xinzhu.xuezhibao.immodule.pickerimage.utils.RequestCode;
import com.xinzhu.xuezhibao.immodule.pickerimage.view.BaseZoomableImageView;
import com.xinzhu.xuezhibao.immodule.pickerimage.view.ToolBarOptions;
import com.xinzhu.xuezhibao.immodule.pickerimage.view.UIView;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.picker_image_preview_photos_select) {
            ...
            if (selectPhotoList != null && selectPhotoList.size() == 0) {
                ...
                BToast.info(PickerAlbumPreviewActivity.this).text( "请至少选择一张发送").show();
            }else {

...
public class SendImageHelper {
    ...
    public static void sendImageAfterSelfImagePicker(Context context,  List<String> photos, final Callback callback) {
        boolean isOrig = true;
    ...
    public static class SendImageTask extends AsyncTask<Void, Void, File> {
        ...
        public SendImageTask(Context context, boolean isOrig, String info,
                             Callback callback) {
